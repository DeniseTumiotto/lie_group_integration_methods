      ...
      pure function qlpexphDqtilde(this, q, h, Dq) result(rslt)
         ...
         select case (this%liegroup)
            ...
            case (6) ! semidirect product with S^3
              rslt = 0.0_8
              do i = 1, this%number_heavy_tops
                  unit_rslt = expt_s3sdr3(h*Dq(6*i-5:6*i))
                  rslt(7*i-6:7*i) = lp_s3sdr3(q(7*i-6:7*i), unit_rslt)
              end do
      ...
      pure function itlbtvtw(this, v, w) result(rslt)
         ...
         select case (this%liegroup)
            ...
            case (5, 6, 7)
              rslt = 0.0_8
              do i = 1, this%number_heavy_tops
                 associate (Om1 => v(6*i-5:6*i-3),&
                            Om2 => w(6*i-5:6*i-3),&
                             U1 => v(6*i-2:6*i),&
                             U2 => w(6*i-2:6*i))
                    rslt(6*i-5:6*i-3) = cross(Om1, Om2)
                    rslt(6*i-2:6*i) = cross(Om1, U2) - cross(Om2, U1)
                 end associate
             end do
         end select
      ...
      pure function Tg(this, h, dq) result(rslt)
         ...
         select case (this%liegroup)
            ...
            case (5, 6, 7)
              rslt = 0.0_8
              do i = 1, this%number_heavy_tops
                rslt(6*i-5:6*i,6*i-5:6*i) = tan_op_s3sdr3(h*dq(6*i-5:6*i))
              end do
         end select
      end function Tg
      ...
      pure function Tg_inv_T(this, dq) result(rslt)
         ...
         select case (this%liegroup)
            ...
            case (5, 6, 7)
              rslt = 0.0_8
              do i = 1, this%number_heavy_tops
                rslt(6*i-5:6*i,6*i-5:6*i) = tan_tr_inv_s3sdr3(dq(6*i-5:6*i))
              end do
         end select
      ...
      pure function d_Tg_inv_T(this, v, w) result(rslt)
         ...
         select case (this%liegroup)
            ...
            case (5, 6, 7)
              rslt = 0.0_8
              do i = 1, this%number_heavy_tops
                rslt(6*i-5:6*i,6*i-5:6*i) = d_tan_tr_inv_s3sdr3(v(6*i-5:6*i),w(6*i-5:6*i))
              end do
         end select
      ...
      pure function M(this, q) result(rslt)
         ...
         select case (this%liegroup)
            case (1, 2)
               ...
               rslt = rslt - this%mass(1) * matmul(skw(this%refX(1:3)),skw(this%refX(1:3)))
            case (3:7)
              rslt(:,:) = 0.0_8
              do i = 1, this%number_heavy_tops
                rslt(6*i-5:6*i-3,6*i-5) = [this%inerJ(3*i-2),0.0_8,0.0_8]
                rslt(6*i-5:6*i-3,6*i-4) = [0.0_8,this%inerJ(3*i-1),0.0_8]
                rslt(6*i-5:6*i-3,6*i-3) = [0.0_8,0.0_8,this%inerJ(3*i)]
                rslt(6*i-2:6*i,6*i-2) = [this%mass(i),0.0_8,0.0_8]
                rslt(6*i-2:6*i,6*i-1) = [0.0_8,this%mass(i),0.0_8]
                rslt(6*i-2:6*i,6*i) = [0.0_8,0.0_8,this%mass(i)]
              end do
         end select
        end function M
      ...
      pure function inertial(this, v) result(rslt)
         ...
         select case (this%liegroup)
            case (1, 2)
               ...
               massm = massm - this%mass(1) * matmul(skw(this%refX(1:3)),skw(this%refX(1:3)))
            ...
            case (5, 6, 7)
              rslt = 0.0_8
              do i = 1, this%number_heavy_tops
                associate ( Om => v(6*i-5:6*i-3),&
                             U => v(6*i-2:6*i))
                  rslt(6*i-5:6*i-3) = cross(Om, this%inerJ(3*i-2:3*i)*Om)
                  rslt(6*i-2:6*i) = this%mass(i)*cross(Om, U)
                end associate
              end do
         end select
         rslt = -rslt
      ...
      pure function f(this, q, v, t) result(rslt)
         ...
         select case (this%liegroup)
            ...
            case (6)
              rslt = 0.0_8
              do i = 1, this%number_heavy_tops
               associate ( p => q(7*i-6:7*i-3),&
                           x => q(7*i-2:7*i))
                  rslt(6*i-5:6*i-3) = 0.0_8
                  rslt(6*i-2:6*i) = this%mass(i)*apply_conj_quat(p,this%gravity)
               end associate
             end do
            case (7)
               associate (pR => q(1:4),&
         ...
         select case (this%liegroup)
            ...
            case (4, 6)
              ...
              do i = 1, this%number_heavy_tops
               associate ( p => q(7*i-6:7*i-3))
                  if (i == 1) then
                    rslt(i:i+2) = apply_conj_quat(p, q(i+4:i+6)) - this%refX(3*i-2:3*i)
                  else
                    rslt(3*i-2:3*i) = apply_conj_quat(p, q(7*i-2:7*i)-q(7*i-9:7*i-7)) - (this%refX(3*i-2:3*i)-this%refX(3*i-5:3*i-3))
                  end if
               end associate
             end do
            case (3, 5)
...
! GUBED
      ...
      pure function B(this,q) result(rslt)
         ...
         ! internal varialbles
         integer                                   :: i
         real(8), dimension(3,6)                   :: unit_rslt
         !
         select case (this%liegroup)
            case (1, 2)
            ...
            case (5, 6, 7)
              ...
              unit_rslt = 0.0_8
              do i = 1, this%number_heavy_tops
               unit_rslt(:,1:3) = skw(this%refX(3*i-2:3*i))
               unit_rslt(:,4)   = [1.0_8, 0.0_8, 0.0_8]
               unit_rslt(:,5)   = [0.0_8, 1.0_8, 0.0_8]
               unit_rslt(:,6)   = [0.0_8, 0.0_8, 1.0_8]
               rslt(3*i-2:3*i,6*i-5:6*i) = unit_rslt
               if (.not. i == 1) then
                 rslt(3*i-2,6*(i-1)-2:6*(i-1)) = [-1.0_8, 0.0_8, 0.0_8]
                 rslt(3*i-1,6*(i-1)-2:6*(i-1)) = [0.0_8, -1.0_8, 0.0_8]
                 rslt(3*i,6*(i-1)-2:6*(i-1)) = [0.0_8, 0.0_8, -1.0_8]
               end if
	      end do
         end select
      end function B
      ...
      pure function Ct(this, q, v, t) result(rslt)
         ...
         ! internal varialbles
         integer                             :: i
         real(8), dimension(6,6)             :: unit_rslt
         !
         select case (this%liegroup)
            case (1, 2)
            ...
            case (5, 6, 7)
              ...
              do i = 1, this%number_heavy_tops
                 associate (Om => v(6*i-5:6*i-3),&
                             U => v(6*i-2:6*i))
                    unit_rslt(1:3,1:3)         = skw(Om)
                    unit_rslt(1:3,1)           = unit_rslt(1:3,1)*this%inerJ(3*i-2)
                    unit_rslt(1:3,2)           = unit_rslt(1:3,2)*this%inerJ(3*i-1)
                    unit_rslt(1:3,3)           = unit_rslt(1:3,3)*this%inerJ(3*i)
                    unit_rslt(1:3,1:3)         = unit_rslt(1:3,1:3) - skw(this%inerJ(3*i-2:3*i) * Om)
                    !
                    unit_rslt(4:6,1:3)         = - skw(this%mass(i)*U)
                    unit_rslt(1:3,4:6)         = 0.0_8
                    unit_rslt(4:6,4:6)         = skw(this%mass(i)*Om)
                    rslt(6*i-5:6*i, 6*i-5:6*i) = unit_rslt
                 end associate
             end do
         end select
      end function Ct
      ...
      pure function Kt_lambda(this, q, v, vd, l, t) result(rslt)
         ...
         select case (this%liegroup)
            ...
            case (6)
              ...
              unit_rslt = 0.0_8
              do i = 1, this%number_heavy_tops
                 associate (p => q(4*i-3:4*i))
                    unit_rslt(1:3,1:3) = 0.0_8
                    unit_rslt(4:6,1:3) = - skw(this%mass(i) * apply_conj_quat(p, this%gravity))
                    unit_rslt( : ,4:6) = 0.0_8
                 end associate
                 rslt(6*i-5:6*i, 6*i-5:6*i) = unit_rslt
             end do
      ...
      subroutine init(this)
         ...
         select case (this%liegroup)
            ...
            case (5) ! SE(3)
               ...
               this%sizel = 3
            case (6) ! S^3 |x R^3
               this%sizeq = (4+3) * this%number_heavy_tops
               this%sizev = (3+3) * this%number_heavy_tops
               this%sizel = 3 * this%number_heavy_tops
            case (7) ! UDQ
               this%sizeq = 4+4
               this%sizev = 3+3
               this%sizel = 3
         ...
         if (allocated(this%refX)) then
            deallocate(this%refX)
         end if
         allocate(this%refX(3*this%number_heavy_tops))
         !
         do i = 1, this%number_heavy_tops
           this%refX(3*i-2:3*i) = apply_conj_quat(this%p0(4*i-3:4*i), this%x0(3*i-2:3*i))
         end do
         ...
         select case (this%liegroup)
            ...
            case (6) ! S^3 |x R^3
              do i = 1, this%number_heavy_tops
                 this%q(7*i-6:7*i-3) = this%p0(4*i-3:4*i)
                 this%q(7*i-2:7*i) = this%x0(3*i-2:3*i)
                 this%v(6*i-5:6*i-3) = this%Om0(3*i-2:3*i)
               if (i == 1) then
                 this%v(6*i-2:6*i) = cross(this%Om0(3*i-2:3*i), this%refX(3*i-2:3*i))
               else
                 this%v(6*i-2:6*i) = this%v(6*(i-1)-2:6*(i-1)) + cross(this%Om0(3*i-2:3*i), this%refX(3*i-2:3*i)-this%refX(3*(i-1)-2:3*(i-1)))
               end if
              end do
            case (7) ! UDQ
               this%q(1:4) = this%p0
